<template>
  <div class="h-screen w-screen dark:bg-darkMode-main flex justify-center items-center">
    <button @click="toggleTheme">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="theme-icon fill-white"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="theme-icon fill-black" v-else>
        <path
